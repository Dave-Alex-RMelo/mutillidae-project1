...
<div class="page-title">Account recovery</div>
...
<div id="id-registration-form-div">
	<form	action="index.php?page=register.php" method="post" enctype="application/x-www-form-urlencoded"
		...
		<table>
			...
			<tr>
				<td colspan="2" class="form-header">Please choose your email for to Retrieve now your account</td>
			</tr>
				...
				<td>
					...
					<?php
						if ($lEnableHTMLControls) {
							echo('minlength="1" maxlength="25" required="required"');
						}// end if
					?>
					/>
				</td>
			...
			<tr>
				<td colspan="2" style="text-align:center;">
					<input name="register-php-submit-button" class="button" type="submit" value="Send" />
				</td>
			</tr>
